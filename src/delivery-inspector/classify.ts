 ...
 * - `generated` precedes `project_state` so a generated NewFang markdown view is not mistaken for
 *   canonical state, and both precede `documentation` so `.newfang/**\/*.md` is not called docs.
...
const RULES: readonly Rule[] = [
  ...
  },
  {
    category: "generated",
    confidence: "high",
    reason: "generated NewFang view under .newfang/",
    matches: (p) => underDirectory(p, ".newfang") && DOC_EXTENSIONS.includes(p.ext),
  },
  {
    category: "generated",
    confidence: "medium",
  ...
  },
  {
    ...
    confidence: "high",
    reason: "canonical NewFang project state under .newfang/",
    matches: (p) => underDirectory(p, ".newfang"),
  },
  {
    category: "ci",
    confidence: "high",
