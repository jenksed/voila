...
/** A valid Packet 4 (schema v4) canonical state, for v4 -> v5 migration tests. */
export const V4_FIXTURE = {
  schemaVersion: 4,
  projectId: "v4-project-id",
  displayName: "ops-demo",
  phase: "build",
  health: "green",
  nextAction: "Begin R2A.",
  nextActionRationale: "R1 is complete.",
  focusWorkItemId: "NF-10",
  sequences: {
    workItem: 3,
    decision: 2,
    assumption: 2,
